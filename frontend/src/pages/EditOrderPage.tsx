  ...
  useEffect(() => {
    const load = async () => {
      ...
      try {
        ...
        setTaxAmount(String(order.taxAmount));
  ...
  return (
    <div className="space-y-6">
      ...
      <PageCard
        ...
        description="Update the customer, products, quantities, tax, and notes for this draft order."
      >
        <div className="grid gap-6 xl:grid-cols-[minmax(0,1.5fr)_360px]">
            ...
            <section>
              <div className="mb-3">
                ...
                <p className="mt-1 text-sm text-slate-500 dark:text-slate-400">
                  Select the customer associated with
                  this order.
                </p>
              </div>
            ...
            <section className="border-t border-slate-200 pt-6 dark:border-slate-800">
              <div className="mb-3 flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="mt-1 text-sm text-slate-500 dark:text-slate-400">
                    Add another product to this draft
                    order.
                  </p>
                </div>
              </div>
            ...
            <section>
              ...
              {lines.length > 0 ? (
                      ...
                      {lines.map((line) => (
                        ...
                        >
                          ...
                          <td className="px-4 py-3 text-center">
                            <span className="inline-flex min-w-10 items-center justify-center rounded-full bg-slate-100 px-2 py-1 text-xs font-medium text-slate-700 dark:bg-slate-800 dark:text-slate-300">
                              {line.stockQuantity}
                            </span>
                          </td>
                ...
                <div className="rounded-xl border border-dashed border-slate-300 bg-slate-50 px-6 py-10 text-center dark:border-slate-700 dark:bg-slate-950">
                  ...
                  <p className="mt-1 text-sm text-slate-500 dark:text-slate-400">
                    Add a product above to continue.
                  </p>
                </div>
              )}
            </section>
          ...
          <aside>
            <div className="sticky top-6 rounded-2xl border border-slate-200 bg-slate-50 p-5 transition-colors dark:border-slate-800 dark:bg-slate-950">
              ...
              <p className="mt-1 text-sm text-slate-500 dark:text-slate-400">
                Review the updated totals before saving.
              </p>
              ...
              <div className="mt-6 rounded-xl border border-amber-100 bg-amber-50 p-3 dark:border-amber-900/50 dark:bg-amber-950/30">
                <p className="text-xs leading-5 text-amber-700 dark:text-amber-300">
                  This order is still a{" "}
                  <strong>Draft</strong>. Saving changes
                  will not reduce inventory until the
                  order is confirmed.
                </p>
              </div>
